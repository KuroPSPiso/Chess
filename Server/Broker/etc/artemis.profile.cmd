...
set ARTEMIS_HOME="E:\DPI\Chess\Server\apache-artemis-2.0.0"
set ARTEMIS_INSTANCE="E:\DPI\Chess\Server\Broker"
...
rem Java Opts
set JAVA_ARGS=-XX:+UseParallelGC -XX:+AggressiveOpts -XX:+UseFastAccessorMethods -Xms512M -Xmx1024M -Xbootclasspath/a:%ARTEMIS_HOME%\lib\jboss-logmanager-2.0.3.Final.jar -Djava.security.auth.login.config=%ARTEMIS_INSTANCE%\etc\login.config  -Dartemis.instance=%ARTEMIS_INSTANCE%
